    ...
    <div className="sticky top-0 flex flex-col justify-between h-screen w-72 border-r border-gray-200 bg-white shadow-sm">
      <div>
        ...
        <div className="flex items-center gap-3 p-6 border-b border-gray-100">
          <div className="bg-gradient-to-br from-cyan-600 to-blue-600 text-white rounded-full w-14 h-14 flex items-center justify-center font-bold text-lg shadow-lg">
            {getUserInitials()}
          </div>
