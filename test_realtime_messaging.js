// Test script to verify real-time messaging fixes
...
console.log('🧪 Testing real-time messaging fixes...\n');
...
// Test 5: Test multiple messages to verify real-time updates
setTimeout(() => {
  console.log('\n5️⃣ Testing multiple messages for real-time updates...');
  doctorSocket.emit('send-message', {
    receiverId: PATIENT_USER_ID,
    appointmentId: APPOINTMENT_ID,
